...
public class HomeController {
	...
	@RequestMapping(value="/updateUserInfoPage", method=RequestMethod.POST)
...
//		update password
	...
	@RequestMapping("/listOfCreditCardsPage")
	public String listOfCreditCardsPage(
	...
	@RequestMapping("/addNewCreditCardPage")
	public String addNewCreditCardPage(
	...
	@RequestMapping(value="/addNewCreditCardPage", method=RequestMethod.POST)
	public String addNewCreditCardPage(
	...
	@RequestMapping("/updateCreditCardPage")
	public String updateCreditCardPage(
	...
	@RequestMapping("/removeCreditCardPage")
	public String removeCreditCardPage(
			@ModelAttribute("id") Long creditCardId, Principal principal, Model model
			){
		User user = userService.findByUsername(principal.getName());
		UserPayment userPayment = userPaymentService.findById(creditCardId);
	...
	@RequestMapping("/addNewShippingAddressPage")
	public String addNewShippingAddressPage(
			Model model, Principal principal
			){
		User user = userService.findByUsername(principal.getName());
		model.addAttribute("user", user);
	...
	@RequestMapping(value="/addNewShippingAddressPage", method=RequestMethod.POST)
	public String addNewShippingAddressPostPage(
	...
	@RequestMapping("/selectedBookQuickView")
...
/*		if(principal != null) {
	...
	@RequestMapping("/updateUserShippingPage")
	public String updateUserShippingPage(
			@ModelAttribute("id") Long shippingAddressId, Principal principal, Model model
			) {
		User user = userService.findByUsername(principal.getName());
		UserShipping userShipping = userShippingService.findById(shippingAddressId);
	...
	@RequestMapping(value="/setDefaultShippingAddressPage", method=RequestMethod.POST)
	public String setDefaultShippingAddressPage(
			@ModelAttribute("defaultShippingAddressId") Long defaultShippingId, Principal principal, Model model
			) {
		User user = userService.findByUsername(principal.getName());
		userService.setUserDefaultShipping(defaultShippingId, user);
	...
	@RequestMapping("/removeUserShippingPage")
	public String removeUserShippingPage(
			@ModelAttribute("id") Long userShippingId, Principal principal, Model model
			){
		User user = userService.findByUsername(principal.getName());
		UserShipping userShipping = userShippingService.findById(userShippingId);
